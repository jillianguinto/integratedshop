...
class Customers extends CI_Controller {
	...
	{					 		
		...
		$getAllcustomer	= $this->Customermod->getcustomerinfo($this->store_id);
		...
		$userData['storeID'] = $this->Customermod->getWebsiteIds($this->store_id);
	...
	public function view()
	{
		...
		$getCustomerByCustomerId[0]->address_information =  $this->Customermod->get_customer_address($customerId);	
	...
	public function add_customer_account(){	
		...
		*/
		...
		$store_id  		= $this->input->post('customerStore');
		$usersession 	= is_usersession();
		$baseurl = base_url();
		if(empty($usersession)):
			redirect($baseurl);
	...
	{
		$store_id  		= $this->store_id;
		$website_ids = $this->Customermod->getWebsiteIdOnly($store_id);
		
		$getAllcustomer	= $this->Customermod->getExportCust($website_ids);
