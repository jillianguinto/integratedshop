					...
					<div class="collapse navbar-collapse navbar-ex1-collapse">
						...
						<ul class="nav navbar-nav side-nav">
							...
							<li><a href="javascript:;" data-toggle="collapse" data-target="#reports" <?php if($this->uri->segment(1) == 'sumReport'): ?> class="parent-active" aria-expanded="true" <?php endif;?>><i class="fa fa-shopping-cart"></i> Month-end-reports <i class="fa fa-fw fa-caret-down"></i></a>
								<ul id="reports" <?php if($this->uri->segment(1) == 'sumReport'): ?> class="collapse in" aria-expanded="true" <?php else: ?> aria-expanded="false" class="collapse" style="height: 0px;" <?php endif;?> >
...
function logStore2()
{
	...
	//http://clickhealth.ecomqa.com/adminuser/index.php/login/
	// $.post('../index.php/default/connectmage/login',{
	// $.post('http://clickhealth.ecomqa.com/adminuser/index.php/login/',{
	...
	// 		$.ajax({
	// 		  url: "http://clickhealth.ecomqa.com/adminuser/index.php/Store",
	// 		  cache: false
	// 		})
	// 		.done(function( html ) {
	// 		    $( "#test" ).append( html );
