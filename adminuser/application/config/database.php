...
$host_name 	   = $arrConnection['host'];
$host_username = $arrConnection['username'];
$host_password = $arrConnection['password'];
$host_database = $arrConnection['dbname'];
