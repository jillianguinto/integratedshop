                ...
                //end edit checkout session billing information
                    ...
                    if($data['save_in_address_book'] == 1){
                            ...
                            $customeremail = $data['emailaddress'];
                                    ...
                                    $sqlUpdatenew_ = "UPDATE sales_flat_quote_address set firstname='$firstname_billing ', lastname='$lastname_billing ', street='$street_billing ', city='$city_name ', region='$region_billing ', region_id='$regionid_billing', telephone='$telephone_billing ', mobile='$mobile_billing', postcode='$postcode_billing ', fax='$fax' WHERE quote_id='$quote_id' AND address_type ='billing'";
            ...
            try{
                ...
                if($customerAddressId == 0){
                    ...
                    if($firstname != '' && $lastname != '' && $country != '' && $postcode != '' && $regionid != '' && $city != '' && $street != '' && $mobile != ''):
                        ...
                        $sqlUpdatenew_ = "UPDATE sales_flat_quote_address set firstname='$firstname', lastname='$lastname', street='$street', city='$city_name', region='$region', region_id='$regionid', telephone='$telephone', postcode='$postcode' 
                        WHERE quote_id='$quote_id' AND address_type ='shipping'";
    ...
    **/
    ...
    public function saveOrderAction()
    {
        ...
        try {
            ...
            if ($data) {
                Mage::log($data['checks'], null, "datadata.log");
