    ...
    public function savenewBillingAction()
    {
        ...
        if ($this->getRequest()->isPost()) {
            ...
            if($customerAddressId != 0){
                ...
                $sqlUpdate = "UPDATE sales_flat_quote_address set firstname='$firstname', lastname='$lastname', street='$street', city='$city', region='$region', region_id='$regionid', telephone='$telephone', postcode='$postcode', fax='$fax'
                ...
                if($data['use_for_shipping'] == 1):
                    ...
                    $sqlUpdate_ = "UPDATE sales_flat_quote_address set firstname='$firstname', lastname='$lastname', street='$street', city='$city', region='$region', region_id='$regionid', telephone='$telephone', postcode='$postcode', fax='$fax'
                ...
                //end edit checkout session billing information
                    ...
                    if($data['save_in_address_book'] == 1){
                            ...
                            $customeremail = $data['emailaddress'];
                                    ...
                                    $sqlUpdatenew = "UPDATE sales_flat_quote_address set firstname='$firstname', lastname='$lastname', street='$street', city='$city', region='$region', region_id='$regionid', telephone='$telephone', postcode='$postcode', fax='$fax' 
                                    WHERE quote_id='$quote_id' AND address_type ='billing'";
                                    ...
                                    $sqlUpdatenew_ = "UPDATE sales_flat_quote_address set firstname='$firstname', lastname='$lastname', street='$street', city='$city', region='$region', region_id='$regionid', telephone='$telephone', postcode='$postcode', fax='$fax' 
                                    WHERE quote_id='$quote_id' AND address_type ='shipping'";
                                    ...
                                    $sqlUpdatenew_ = "UPDATE sales_flat_quote_address set firstname='$firstname_shipping', lastname='$lastname_shipping', street='$street_shipping', city='$city_shipping', region='$region_shipping', region_id='$regionid_shipping', 
                                    telephone='$telephone_shipping', postcode='$postcode_shipping', fax='$fax' WHERE quote_id='$quote_id' AND address_type ='shipping'";
            ...
            try{
                ...
                if($customerAddressId == 0){
                    ...
                    if($firstname != '' && $lastname != '' && $country != '' && $postcode != '' && $regionid != '' && $city != '' && $street != '' && $mobile != ''):
                        ...
                        $sqlUpdatenew_ = "UPDATE sales_flat_quote_address set firstname='$firstname', lastname='$lastname', street='$street', city='$city', region='$region', region_id='$regionid', telephone='$telephone', postcode='$postcode' 
                        WHERE quote_id='$quote_id' AND address_type ='shipping'";
...
public function saveanotherShippingAction()
{
    ...
    if ($this->getRequest()->isPost()) {
        ...
        try{
            ...
            if($firstname != '' && $lastname != '' && $country != '' && $postcode != '' && $regionid != '' && $city != '' && $street != '' && $telephone != ''):
    ...
    **/
    ...
    public function saveOrderAction()
    {
        ...
        try {
            ...
            //Mage::log($e, null, 'errrer.log');
            Mage::log($e->getMessage(), null, 'errrer.log');
        }
