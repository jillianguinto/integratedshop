        ...
        if ($order = $this->_initOrder()) {
            ...
            try {
                ...
                $order  ->cancel()
                    ...
                    $netsuiteApiEnabled   = Mage::getStoreConfig('webservice/netsuiteregsettings/netsuiteregenabled',$storeidapi);
                        ...
                        if($netsuiteApiEnabled == 1 ){
                             Mage::getModel('webservice/netsuite_postdata_order')->cancelOrder($orderId, $storeidapi );
                         }
                ...
                {   
                    ...
                    //Mage::log('id- '.$orderId,null,'healthplus.log');

                     Mage::getModel('healthplus/healthplus')->cancelOrder($orderId);

                }else{

                    Mage::log('error- '.$healthplusEnabled,null,'healthplus.log');
