...

{
...

    {
        ...
        $storeidapi           = $customer->getStoreId();
        ...
        if($netsuiteApiEnabled == 1 ){
...

            {
                ...
                $data = array(
                    ...
                    'label'     =>  'Send to NetSuite',             

                    'onclick'   =>  "setLocation('".$this->getUrl('webservice/adminhtml_resend/sendcustomerstoNetsuite/id/' . $id) ."')",               
                ...
                $this->addButton('form_back', $data, 0, 100, 'header'); 
