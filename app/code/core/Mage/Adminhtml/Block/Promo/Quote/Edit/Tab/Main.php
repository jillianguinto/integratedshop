    ...
    implements Mage_Adminhtml_Block_Widget_Tab_Interface
{
    ...
    protected function _prepareForm()
    {
        ...
        $fieldset->addField('agelimit', 'text', array(
            'name' => 'agelimit',
            'label' => Mage::helper('salesrule')->__('Age Limit'),
            'required' => true,
        ));
       ...
       $fieldset->addField('is_gift', 'select', array(
            'name'       => 'is_gift',
            'label'      => Mage::helper('salesrule')->__('Is Gift'),
            'required'   => true,
            'options'   => array(
        ...
        $fieldset->addField('code_val', 'select', array(
            'label'     => Mage::helper('catalogrule')->__('Code Validity'),
            'title'     => Mage::helper('catalogrule')->__('Code Validity'),
            'name'      => 'code_val',
            'required' => false,
            'options'    => array(
                '0' => Mage::helper('catalogrule')->__('None'),
                '1' => Mage::helper('catalogrule')->__('Daily'),
                '2' => Mage::helper('catalogrule')->__('Monthly'),
                '3' => Mage::helper('catalogrule')->__('Yearly'),
            ),
        ));     
