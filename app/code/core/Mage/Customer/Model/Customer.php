...
class Mage_Customer_Model_Customer extends Mage_Core_Model_Abstract
{
	...
	$storeCode 	= Mage::app()->getStore()->getCode();
        $webtoken 	= Mage::getModel('webservice/validate_token')->forgotpasswordToken();   
	$link 		= "https://shop.clickhealth.com.ph/index.php/" . $storeCode . "/customer/account/resetpassword/"; 


        $this->_sendEmailTemplate(self::XML_PATH_FORGOT_EMAIL_TEMPLATE, self::XML_PATH_FORGOT_EMAIL_IDENTITY,
            array('customer' => $this,
                  'webtoken' => $webtoken.":".$currentstoreid,
		  'link' => $link), $storeId); 
