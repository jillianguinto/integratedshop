 ...
 */
class Gurutheme_Advancedquickorder_Block_Catalog_Product_View_Options extends Mage_Catalog_Block_Product_View_Options
{
    protected $_rowId;
     ...
     * @return string
     */
    public function getOptionsPriceJsonConfig()
    {
        $config = array();
        if (!$this->hasOptions()) {
