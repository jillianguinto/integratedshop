...
//        $collection->joinLeft('increment_id',
//            'sales/order',
//            'increment_id',
//            'order_id=entity_id',
//            '1=1',
//            'left');
    ...
    {
//        $this->addColumn('in_dropships',array(
//            'header_css_class' 	=> 'a-center',
//            'type' 		=> 'checkbox',
//            'name'		=>'in_dropships',
//            'values'            => $this->_getSelectedDropships(),
//            'align'             => 'center',
//            'index'             => 'dropship_id'
//        ));
...
//            'filter_condition_callback' => array($this, 'filterCreatedOn')
    ...
    public function getGridUrl()
    {
        return $this->getData('grid_url')
            ...
            : $this->getUrl('*/*/supplierdropshipGrid', array('_current'=>true,'order_id'=>$this->getRequest()->getParam('order_id')));
    }
