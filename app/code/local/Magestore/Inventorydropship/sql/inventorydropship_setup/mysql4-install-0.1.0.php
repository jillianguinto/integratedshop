...
$installer->run("
    ...
    DROP TABLE IF EXISTS {$this->getTable('erp_inventory_dropship')};
    CREATE TABLE {$this->getTable('erp_inventory_dropship')} (
    ...
    DROP TABLE IF EXISTS {$this->getTable('erp_inventory_dropship_product')};
    CREATE TABLE {$this->getTable('erp_inventory_dropship_product')} (
    ...
    ALTER TABLE {$this->getTable('erp_inventory_supplier')} 
        ADD `password_hash` varchar(255) default '';
	
    ALTER TABLE {$this->getTable('erp_inventory_shipment')} 
        ADD `supplier_id` int(11) unsigned NOT NULL,
        ADD `supplier_name` varchar(255) default '';
");
