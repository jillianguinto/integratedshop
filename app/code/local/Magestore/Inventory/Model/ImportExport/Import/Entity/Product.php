 ...
 */
class Magestore_Inventory_Model_ImportExport_Import_Entity_Product extends Mage_ImportExport_Model_Import_Entity_Product
{    
                    ...
                    try{
                        ...
                        if($unWarehouse->getId()){
                            ...
                            if($warehouseProduct->getId()){
                                $warehouseProduct->setData('qty',$warehouseProduct->getQty() + ($newQty-$oldQty))
                                                 ->setData('qty_available',$warehouseProduct->getQtyAvailable() + ($newQty-$oldQty))
                                                 ->save();
                            }else{
                                Mage::getModel('inventory/warehouseproduct')
                                        ->setData('warehouse_id',$unWarehouse->getId())
                                        ->setData('product_id',$productId)
                                        ->setData('qty',$newQty-$oldQty)
                                        ->setData('qty_available',$newQty-$oldQty)
                                        ->save();
                            }
                        }
                    }catch(Exception $e){
