...
class Magestore_Inventory_Block_Adminhtml_Sendstock_Edit_Tab_Products extends Mage_Adminhtml_Block_Widget_Grid {
    ...
    protected function _prepareCollection() {
        ...
        if (!$id) {
            ...
            $collection->joinField('qty', 'inventory/sendstockproduct', 'qty', 'product_id=entity_id', "{{table}}.send_stock_id=$id", 'inner');
        }
    ...
    public function getSelectedProducts() {
        ...
        $products = array();
        $productCollection = Mage::getResourceModel('inventory/sendstockproduct_collection')
                ->addFieldToFilter('send_stock_id', $sendStock->getId());
    ...
    public function getSendstock() {
        return Mage::getModel('inventory/sendstock')
