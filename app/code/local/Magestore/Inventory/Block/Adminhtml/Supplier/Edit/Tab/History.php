...
class Magestore_Inventory_Block_Adminhtml_Supplier_Edit_Tab_History extends Mage_Adminhtml_Block_Widget_Grid {
    ...
    protected function _prepareCollection() {
        ...
        $collection = Mage::getModel('inventory/supplierhistory')->getCollection()
    ...
    protected function _prepareColumns() {
        ...
        $this->addColumn('field_change', array(
            ...
            'renderer' => 'inventory/adminhtml_supplier_edit_tab_renderer_fieldchanged',
        ...
        $this->addColumn('show_history', array(
            ...
            'filter' => false,
            'sortable' => false,
            'renderer' => 'inventory/adminhtml_supplier_edit_tab_renderer_history'
        ));
