...
class Magestore_Inventory_Block_Adminhtml_Supplier_Edit_Tab_Products extends Mage_Adminhtml_Block_Widget_Grid {
    ...
    public function getSelectedRelatedProducts() {
        ...
        $productCollection = Mage::getResourceModel('inventory/supplierproduct_collection')
    ...
    public function getSupplier() {
        return Mage::getModel('inventory/supplier')->load($this->getRequest()->getParam('id'));
    }
