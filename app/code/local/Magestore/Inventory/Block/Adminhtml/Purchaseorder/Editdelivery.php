 ...
 */
class Magestore_Inventory_Block_Adminhtml_Purchaseorder_Editdelivery extends Mage_Adminhtml_Block_Widget_Form_Container
{
    public function __construct()
    {
        ...
        $this->_updateButton('save', 'label', Mage::helper('inventory')->__('Create Delivery'));
        ...
        $this->_formScripts[] = "
            ...
            function uploadFile() {
               ...
               xhr.open('POST', '".$this->getUrl('inventoryadmin/adminhtml_purchaseorder/importproductforcreatedelivery')."');
               xhr.send(fd);
           }
    ...
    public function getHeaderText()
    {
        if (Mage::registry('purchaseorder_data')
            ...
            return Mage::helper('inventory')->__("Create New Delivery For Purchase Order No. '%s'",
