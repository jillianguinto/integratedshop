 ...
 */
class Magestore_Inventory_Block_Adminhtml_Purchaseorder_New extends Mage_Adminhtml_Block_Widget_Form_Container {
    ...
    public function getHeaderText() {
        if (Mage::registry('purchaseorder_data')
            ...
            return Mage::helper('inventory')->__("Edit Order No. '%s'", $this->htmlEscape(Mage::registry('purchaseorder_data')->getName())
            );
        }
