 ...
 */
class Magestore_Inventory_Block_Adminhtml_Purchaseorder_Returnorder_Tabs extends Mage_Adminhtml_Block_Widget_Tabs
{
    public function __construct()
    {
        ...
        $this->setTitle(Mage::helper('inventory')->__('Order Return'));
    }
