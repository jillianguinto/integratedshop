 ...
 */
class Magestore_Inventory_Block_Adminhtml_Stockissuing_Edit extends Mage_Adminhtml_Block_Widget_Form_Container
{
    public function __construct()
    {
        ...
        $this->_updateButton('save', 'label', Mage::helper('inventory')->__('Save Stock Issuing'));
        ...
        $this->_formScripts[] = "
            ...
            function uploadFile() {
                ...
                xhr.open('POST', '" . $this->getUrl('inventoryadmin/adminhtml_stockissuing/getImportCsv') . "');
                xhr.send(fd);
           }
           ...
           function uploadComplete(evt) {
                   $('stockissuing_tabs_products_section').addClassName('notloaded');
                   stockissuing_tabsJsTabs.showTabContent($('stockissuing_tabs_products_section'));
    ...
    public function getHeaderText()
    {
        if (Mage::registry('stockissuing_data')
            ...
            return Mage::helper('inventory')->__("Edit Stock Issuing '%s'",
                                                $this->htmlEscape(Mage::registry('stockissuing_data')->getTitle())
            );
        }
        return Mage::helper('inventory')->__('Add Stock Issuing');
    }
}