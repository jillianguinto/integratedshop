 ...
 */
class Magestore_Inventory_Block_Adminhtml_Stockissuing_View_Tabs extends Mage_Adminhtml_Block_Widget_Tabs
{
    ...
    protected function _beforeToHtml()
    {
        $this->addTab('form_section', array(
            ...
            'content'   => $this->getLayout()
                                ->createBlock('inventory/adminhtml_stockissuing_view_tab_form')
                                ->toHtml(),
        ));
        ...
        $this->addTab('products_section',array(
                ...
                'content'   => $this->getLayout()
                                ->createBlock('inventory/adminhtml_stockissuing_view_tab_products')
                                ->toHtml(),
        ));
