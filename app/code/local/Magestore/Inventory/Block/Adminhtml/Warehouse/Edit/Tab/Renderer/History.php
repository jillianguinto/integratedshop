<?php 
class Magestore_Inventory_Block_Adminhtml_Warehouse_Edit_Tab_Renderer_History
	extends Mage_Adminhtml_Block_Widget_Grid_Column_Renderer_Abstract
{
    public function render(Varien_Object $row) 
    {
        ...
        return '<p style="text-align:center"><a name="url" href="javascript:void(0)" onclick="showhistory('.$warehouseHistoryId.')">'.Mage::helper('inventory')->__('View').'</a></p>
