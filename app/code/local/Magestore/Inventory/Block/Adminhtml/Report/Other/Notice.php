...
class Magestore_Inventory_Block_Adminhtml_Report_Other_Notice extends Mage_Adminhtml_Block_Widget_Grid {
    ...
    protected function _prepareColumns() {
        ...
        $this->addColumn('notice_date', array(
            'header' => Mage::helper('inventory')->__('Requested Date'),
            'align' => 'left',
            'width' => '50px',
            'index' => 'notice_date',
            'type' => 'date'
        ...
        $this->addExportType('*/*/exportCsvNotice', Mage::helper('inventory')->__('CSV'));
        $this->addExportType('*/*/exportXmlNotice', Mage::helper('inventory')->__('XML'));
    }
