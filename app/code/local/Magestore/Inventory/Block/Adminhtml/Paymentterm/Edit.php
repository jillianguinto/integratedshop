 ...
 */
class Magestore_Inventory_Block_Adminhtml_Paymentterm_Edit extends Mage_Adminhtml_Block_Widget_Form_Container {
    ...
    public function __construct() {
        ...
        $this->_updateButton('delete', 'label', Mage::helper('inventory')->__('Delete'));
    ...
    public function getHeaderText() {
        if (Mage::registry('paymentterm_data')
            ...
            return Mage::helper('inventory')->__("Edit Payment Term '%s'", $this->htmlEscape(Mage::registry('paymentterm_data')->getName())
            );
        }
        return Mage::helper('inventory')->__('Add Payment Term');
    }
