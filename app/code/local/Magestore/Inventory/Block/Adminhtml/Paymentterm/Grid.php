 ...
 */
class Magestore_Inventory_Block_Adminhtml_Paymentterm_Grid extends Mage_Adminhtml_Block_Widget_Grid {
    ...
    protected function _prepareCollection() {
        $collection = Mage::getModel('inventory/paymentterm')->getCollection();
    ...
    protected function _prepareColumns() {
        ...
        $this->addColumn('name', array(
            'header' => Mage::helper('inventory')->__('Payment Term Name'),
            'align' => 'left',
            'width' => '250px',
            'index' => 'name',
        ));
        ...
        $this->addColumn('payment_days', array(
            'header' => Mage::helper('inventory')->__('Payment Period (day)'),
            'index' => 'payment_days',
            'width' => '50px',
            'type' => 'number',
        ));
