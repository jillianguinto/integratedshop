 ...
 */
class Magestore_Inventory_Block_Adminhtml_Stockreceiving_Edit_Tabs extends Mage_Adminhtml_Block_Widget_Tabs
{
    public function __construct()
    {
        parent::__construct();
        $this->setId('stockreceiving_tabs');
    ...
    protected function _beforeToHtml()
    {
        $this->addTab('form_section', array(
            ...
            'content'   => $this->getLayout()
                                ->createBlock('inventory/adminhtml_stockreceiving_edit_tab_form')
                                ->toHtml(),''
        ));
