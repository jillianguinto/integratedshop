...
class Magestore_Inventory_Block_Adminhtml_Stockreceiving_View_Tab_Products extends Mage_Adminhtml_Block_Widget_Grid {
    ...
    protected function _prepareCollection() {
        ...
        $collection->joinField('qty',
                'inventory/stockreceivingproduct',
                'qty',
                'product_id=entity_id',
                "{{table}}.stock_receiving_id=$id",
                'inner');
    ...
    public function getSelectedProducts() {
        $stockReceiving = $this->getStockreceiving();
        $products = array();
        $productCollection = Mage::getResourceModel('inventory/stockireceivingproduct_collection')
