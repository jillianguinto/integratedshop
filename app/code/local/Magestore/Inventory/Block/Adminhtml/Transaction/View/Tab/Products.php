...
class Magestore_Inventory_Block_Adminhtml_Transaction_View_Tab_Products extends Mage_Adminhtml_Block_Widget_Grid {
    ...
    protected function _prepareCollection() {
        ...
        $collection = Mage::getModel('inventory/transactionproduct')
            ->getCollection()
            ->addFieldToFilter('transaction_id',$transaction_id);
    ...
    public function getStockissuing() {
        return Mage::getModel('inventory/transaction')
