 ...
 */
class Magestore_Inventory_Block_Adminhtml_Stocktransfering_Edit_Tab_Products extends Mage_Adminhtml_Block_Widget_Grid {
            ...
            foreach ($stocktransferingProductImports as $productImport) {              
                ...
                if ($productId)
                    $products[$productId] = array(
                        'qty_request' => $productImport['QTY_REQUEST'],
                        'qty_transfer' => $productImport['QTY_TRANSFER'],
                        'qty_receive' => $productImport['QTY_RECEIVE'],
                    );         
            }            
        }
        return $products;
