<?php
class Magestore_Inventory_Block_Adminhtml_Stocktransfering_View extends Mage_Adminhtml_Block_Widget_Form_Container
{
    ...
    public function getHeaderText()
    {
        if (Mage::registry('inventory_data')
            ...
            return Mage::helper('inventory')->__("View Stock Transfering '%s'",
                                                $this->htmlEscape(Mage::registry('inventory_data')->getTitle())
            );
        }
        return Mage::helper('inventory')->__('View Stock Transfering');
    }
}
?>
