...
class Unilab_Adminhtml_Sales_Order_CreditmemoController extends Mage_Adminhtml_Sales_Order_CreditmemoController
{  
    ...
    {   
        ...
        try {
            ...
            if ($creditmemo) {
                ...
                $creditmemo->notifyAccountant(!empty($data['send_email_accountant']));
