...

{
	...
	public function responseAction() 
	{
		...
		{						
			...
			$process = Mage::getModel('bpisecurepay/api')->addData($_GET)->processResponse();
			...
			{ 	
				$order = Mage::getModel('sales/order')->loadByIncrementId($_GET['vpc_MerchTxnRef']);

				Mage::getModel('healthplus/healthplus')->addAvailablecredit($order->getId());	
			}
