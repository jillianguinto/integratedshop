...
class Unilab_Customer_AccountController extends Mage_Customer_AccountController
{
    ...
    public function createPostAction()
    {
        ...
        try 
		{
            ...
            if (empty($errors)) 
			{
			     ...
			     $completeReg = 1;
				Mage::getSingleton('core/session')->setCompleteReg($completeReg);
    ...
    protected function _loginPostRedirect()
	{
           ...
           if($storeid == 31){ //for Digital Data - ADOBE
                Mage::getSingleton('core/session')->setDigitaldataloginsuccess(1);
                $ddlogin = Mage::getSingleton('core/session')->getDigitaldataloginsuccess();
	        }
