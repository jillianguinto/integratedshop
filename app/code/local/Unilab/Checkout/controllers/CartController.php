	...
	extends Mage_Checkout_CartController
{
    ...
    public function addtoCartAction()
	{
		try
		{
			$response['cartcount'] = Mage::helper('checkout/cart')->getItemsCount();
    ...
    public function listAction()
    {
        ...
        $prodname   = trim($this->getRequest()->getParam('prodname'));
        
        
        $html .= "<select name='flavorlist' id='flavorlist'>";
        $html .= "<option></option>";
