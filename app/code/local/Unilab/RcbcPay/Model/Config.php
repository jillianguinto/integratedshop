...
class Unilab_RcbcPay_Model_Config extends Mage_Payment_Model_Config {
	
	const _RCBC_ACCESS_PAYMENT_URL = 'http://122.55.28.62/onlineshopcorp/userSignOn.aspx?orderno=%s';
	
	const _RCBC_SERVICE_URL = 'http://122.55.28.62/getmerchantdata/service.asmx?wsdl';
	...
	protected $_ipayment_config = 'payment/rcbcpay/';
	...
	public function getAccessPaymentUrl($referenceNo=''){
		if(!empty($referenceNo)){
			return sprintf(self::_RCBC_ACCESS_PAYMENT_URL,$referenceNo);
		}
		return '';
	}
}
