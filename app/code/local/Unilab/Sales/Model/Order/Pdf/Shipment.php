<?php 
class Unilab_Sales_Model_Order_Pdf_Shipment extends Mage_Sales_Model_Order_Pdf_Shipment
{
    /**
    ...
    protected function _drawHeader(Zend_Pdf_Page $page)
    {
		...
		$lines[0][] = array(
            'text' => Mage::helper('sales')->__('Items Description'),
            'feed' => 100,
        );
		
		$lines[0][] = array(
            'text' => Mage::helper('sales')->__('Attribute'),
            'feed' => 350,
        );
