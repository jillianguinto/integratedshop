 ...
 */
class Unilab_Ipay88_ProcessController extends Mage_Core_Controller_Front_Action
{
	...
	{				 			
		...
		try
		{						
			$process = Mage::getModel('ipay88/api')
							->addData($_REQUEST)
							->processResponse();
							
			 $this->getResponse()->setRedirect(Mage::getBaseUrl() . "ipay88/process/success");
	        ...
	        $this->_redirect('ipay88/process/failed');
    ...
    {    	
        ...
        $this->getResponse()->setBody($this->getLayout()->createBlock('ipay88/redirect')->toHtml());
