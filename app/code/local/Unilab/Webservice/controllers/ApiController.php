...
{ 
    ...
    {  
        ...
        Mage::log($_GET, null,  $_GET['cmdEvent'] . '_GET_'. $date .'.log'); 
        ...
        try{
            ...
            }elseif($_POST['cmdEvent'] == Unilab_Webservice_Helper_Data::CUSTOMER_LOGINFB){ 
                                   
                $response = Mage::getModel('webservice/function_customer')->LoginCustomerFB($tokendata);
            ...
            //    $response = Mage::getModel('webservice/function_customer')->setforgotpassword();  
               ...
               $customerdata = Mage::getModel('webservice/function_customer')->existingCustomer($tokendata);
