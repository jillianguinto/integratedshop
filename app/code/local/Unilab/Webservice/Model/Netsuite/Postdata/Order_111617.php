...
{	
	...
	{	  
		...
		$successResponse['success'] = $StoreData->success;
		    ...
		    if($successResponse == 1){
				...
				$query= "UPDATE `sales_flat_order` SET `senttoNS` = '$successResponse[success]' ,`senttoNS_date`= '$currentdate',`update_senttoNS` = '$successResponse[success]' ,`update_senttoNS_date`= '$currentdate' WHERE `entity_id` = '$orderId'"; 
	...
	{	
		...
		if($successResponse['success'] == 1){
    		...
    		$query= "UPDATE `sales_flat_order` SET `update_senttoNS` = '$successResponse[success]' ,`update_senttoNS_date`= '$currentdate' WHERE `entity_id` = '$orderId'"; 
    		$this->_getConnection()->query($query);
