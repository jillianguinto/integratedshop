...
class Unilab_Webservice_Model_Function_Customer extends Mage_Core_Model_Abstract    
{
		...
		AND $_POST['dob'] !='' AND $_POST['mobile'] !='')
		{
			...
			if($customerid['customer_id'])
			{
				...
				try
				{
					...
					$this->addShopperwebsite($lastcustomerid, $tokendata['storeid']);
	...
	public function UpdateCustomer()
	{
		if($_POST['email'] !='' AND $_POST['firstname'] !='' AND $_POST['lastname'] !='' AND $_POST['dob'] !='' 
			AND $_POST['gender'] !='' AND $_POST['mobile'] !='' AND $_POST['landline'] !='' AND $_POST['country_id'] !='' AND $_POST['provinceid'] !='' 
	...
	public function LoginCustomer($tokendata) 
    { 
	...
	public function checkCustomerByEmail($email, $websiteId) 
	{
	    ...
	    $customer_info['cityid'] 		= $customerAddress->getCity(); 
	...
	public function addShopperwebsite2()
	{
		
		$customerData = Mage::getSingleton('customer/session')->getCustomer();
      	$lastcustomerid = $customerData->getId();
