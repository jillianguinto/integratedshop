<?php
class Unilab_Expeditedshipping_Model_MyCarrier_Carrier extends Mage_Shipping_Model_Carrier_Abstract
    implements Mage_Shipping_Model_Carrier_Interface
{
    protected $_code = 'expeditedshipping';
    public function collectRates(Mage_Shipping_Model_Rate_Request $request)
    {
		...
		$groups = Mage::getStoreConfig('carriers/expeditedshipping/destinations', 45);
		...
		foreach ($groupie as $key) 
		{
			...
			{
				$minimumorder_value     = Mage::getStoreConfig('carriers/expeditedshipping/minorderval');
				$carriertitle           = Mage::getStoreConfig('carriers/expeditedshipping/title');
				$methodname           = Mage::getStoreConfig('carriers/expeditedshipping/methodname');
				
				$shippingFee     = Mage::getStoreConfig('carriers/expeditedshipping/shippingfee');  
    ...
    public function isavailable($result)
    {
			...
			//Determine equivalent Matrix
            $groups = Mage::getStoreConfig('carriers/expeditedshipping/destinations');
            $groupie = explode(",",$groups);
