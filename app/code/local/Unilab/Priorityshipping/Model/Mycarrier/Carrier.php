<?php
class Unilab_Priorityshipping_Model_MyCarrier_Carrier extends Mage_Shipping_Model_Carrier_Abstract
    implements Mage_Shipping_Model_Carrier_Interface
{
    protected $_code = 'priorityshipping';
    public function collectRates(Mage_Shipping_Model_Rate_Request $request)
    {
		...
		$groups = Mage::getStoreConfig('carriers/priorityshipping/destinations', 45);
		...
		foreach ($groupie as $key) 
		{
			...
			{
				$minimumorder_value     = Mage::getStoreConfig('carriers/priorityshipping/minorderval');
				$carriertitle           = Mage::getStoreConfig('carriers/priorityshipping/title');
				$methodname           = Mage::getStoreConfig('carriers/priorityshipping/methodname');
				
				$shippingFee     = Mage::getStoreConfig('carriers/priorityshipping/shippingfee');  
    ...
    public function isavailable($result)
    {
			...
			//Determine equivalent Matrix
            $groups = Mage::getStoreConfig('carriers/priorityshipping/destinations');
            $groupie = explode(",",$groups);
