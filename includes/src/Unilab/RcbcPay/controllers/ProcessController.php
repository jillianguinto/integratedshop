 ...
 */
class Unilab_RcbcPay_ProcessController extends Mage_Core_Controller_Front_Action
{
	...
	public function savepaymentAction(){
		...
		try{
			...
			Mage::getModel('rcbcpay/api')->callAPI('SavePaymentDetails',$data);
			
			
			$this->getResponse()->setRedirect(Mage::getModel('rcbcpay/config')->getAccessPaymentUrl($data['refno']));
	...
	public function responseAction() 
	{
		try
		{						
			$process = Mage::getModel('rcbcpay/api')
							->addData($_GET)
							->processResponse();
							
			 $this->getResponse()->setRedirect(Mage::getBaseUrl() . "rcbcpay/process/success");
    ...
    {       
        ...
        $this->getResponse()->setBody($this->getLayout()->createBlock('rcbcpay/redirect')->toHtml());
