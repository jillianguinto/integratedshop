 ...
 */ 
	...
	class GoMage_Checkout_Block_Onepage_Abstract extends Mage_Checkout_Block_Onepage_Abstract{
	  ...
	  protected $field_code_to_label = array('company'=>'Company', 'street'=>'Street', 'city'=>'City', 'telephone'=>'Telephone', 'fax'=>'Fax', 'postcode'=>'Zip/Postal', 'country_id'=>'Country', 'region'=>'State/Province','mobile' => 'Mobile');
		...
		public function getSortedFields(){
	    	...
	    	$address_fields = array('company','street','city','telephone','mobile','fax','postcode','country_id','region');
	    	$rows = array();
