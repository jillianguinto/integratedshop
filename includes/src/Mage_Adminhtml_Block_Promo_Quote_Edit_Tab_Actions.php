    ...
    implements Mage_Adminhtml_Block_Widget_Tab_Interface
{
    ...
    protected function _prepareForm()
    {
        ...
        $fieldset->addField('discount_max_amount', 'text', array(            'name' => 'discount_max_amount',            'label' => Mage::helper('salesrule')->__('Maximum Amount Discount is Applied To'),        ));        $model->setDiscountMaxAmount($model->getDiscountMaxAmount()*1);
