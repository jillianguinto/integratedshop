...
Product.Config.prototype.updateFormProductId = function(productId){
	...
	/** Commented to fix issue on add to cart with differed behavior by Jerick Y. Duguran @ Movent, Inc. 
		(jerick.duguran@movent.com)
	**/
	...
	//alert('Developer test:'+productId);
	
	//$('product_addtocart_form').actual_product.value = productId;
...
Product.Config.prototype.reloadPrice = function() {
    ...
    if($('actual_product')){
    	$('actual_product').value = childProductId;
    }
