...
jQuery(document).ready(function() {
    ...
    function showPagethree() {
        ...
        jQuery('.rracheckout-checkout-onepage .right-menu .cart_timeline .payment').css('border-top', '4px solid #E34B08');
    ...
    function showPageFour() {
        ...
        if (showBillingAddress == 'yes') {
            ...
            jQuery('.rracheckout-checkout-onepage .right-menu .cart_timeline .placeholder').css('border-top', '4px solid #E34B08');
    ...
    function showPageFive() {
        ...
        jQuery('.rracheckout-checkout-onepage .right-menu .cart_timeline .payment').css('border-top', '5px solid #E34B08');
        ...
        jQuery('.rracheckout-checkout-onepage .right-menu .cart_timeline .placeholder').css('border-top', '5px solid #E34B08');
...
jQuery(document).ready(function(){
    ...
    // jQuery(".rracheckout-checkout-onepage .customer-name input#shipping_firstname,.rracheckout-checkout-onepage .customer-name input#shipping_lastname,.rracheckout-checkout-onepage .customer-name input#billing_firstname,.rracheckout-checkout-onepage .customer-name input#billing_lastname").keypress(function(e) {
    ...
    //      }
    // });
    jQuery(".rracheckout-checkout-onepage .customer-name input#shipping_postcode,.rracheckout-checkout-onepage .customer-name input#shipping_mobile,.rracheckout-checkout-onepage .customer-name input#billing_postcode,.rracheckout-checkout-onepage .customer-name input#billing_mobile").keypress(function(e) {
        var regex = new RegExp("^[0-9]$");
        var str = String.fromCharCode(!e.charCode ? e.which : e.charCode);
         
       if(!e.charCode || (e.charCode == 43 && jQuery(this).attr('title') == "Mobile")){
              return true;
          }else
          {
            if (regex.test(str)) {
