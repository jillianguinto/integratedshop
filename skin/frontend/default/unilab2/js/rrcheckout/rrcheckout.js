...
jQuery(document).ready(function() {
    ...
    function showPagethree() {
        ...
        jQuery('.rracheckout-checkout-onepage .right-menu .cart_timeline .payment').css('border-top', '5px solid #53bfb8');

        jQuery('.rracheckout-checkout-onepage .right-menu .cart_timeline .payment_link').css('color', '#53bfb8');
    ...
    function showPageFour() {
        ...
        if (showBillingAddress == 'yes') {
            ...
            jQuery('.rracheckout-checkout-onepage .right-menu .cart_timeline .placeholder').css('border-top', '5px solid #53bfb8');

            jQuery('.rracheckout-checkout-onepage .right-menu .cart_timeline .placeorder_link').css('color', '#53bfb8');
